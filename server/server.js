...
app.configure(function() {
  ...
  app.use('/node_modules', express.static('../node_modules')); // required for angular 2 since not bundling the application yet
  app.use('/systemjs.config.js', express.static('../testCode/systemjs.config.js')); // required for systemjs
